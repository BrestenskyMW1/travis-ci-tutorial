[![Build Status](https://travis-ci.org/BrestenskyMW1/travis-ci-tutorial.svg?branch=master)](https://travis-ci.org/BrestenskyMW1/travis-ci-tutorial)
[![Coverage Status](https://coveralls.io/repos/github/BrestenskyMW1/travis-ci-tutorial/badge.svg?branch=master)](https://coveralls.io/github/BrestenskyMW1/travis-ci-tutorial?branch=master)
...
3. Fix the `README.md` badges (replacing all the `BrestenskyMW1` occurrences in the file with `your-github-username`) and push the changes.
